...
(function () {
	...
	BackboneModelWrapper = function ( ractive, model, keypath, prefix ) {
		...
		model.on( 'change', this.changeHandler = function () {
	...
	BackboneModelWrapper.prototype = {
		...
		set: function ( keypath, value ) {
			// Only set if we're not already setting, and only if it's an
			// immediate child property
